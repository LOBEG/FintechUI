...
export function TelegramWhatsAppCTA() {
  return (
    <div className="fixed bottom-5 right-5 z-40 flex flex-col items-end gap-3">
      <motion.a
        href="https://t.me/AurumXSupport"
        target="_blank"
        rel="noopener noreferrer"
        initial={{ opacity: 0, y: 12 }}
        animate={{ opacity: 1, y: 0 }}
        whileHover={{ scale: 1.05 }}
        className="group flex items-center gap-2 pr-4 pl-3 py-2.5 rounded-full text-white shadow-soft border border-white/10"
        style={{ background: 'linear-gradient(135deg, #229ED9 0%, #1a7cb8 100%)' }}
