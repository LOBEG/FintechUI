...
const seed = [
    { role: 'ai', text: 'Hi, I’m Aurelia, NexaVault’s AI trading assistant. Ask me about crypto investing, trading order types, risk management, portfolio allocation, deposits, withdrawals, or how to start safely on NexaVault.' },
];
const investmentKnowledge = [
    {
        keywords: ['start', 'begin', 'new', 'account', 'signup', 'sign up', 'login', 'create'],
        text: 'To start on NexaVault, create an account or sign in first. New users can review public live markets, but investing, selling, wallet funding, watchlists, and trading controls unlock only after secure authentication. Start small, verify your account details, and review risk before placing any order.',
    },
    {
        keywords: ['invest', 'investment', 'portfolio', 'allocate', 'allocation'],
        text: 'A sound crypto investment plan starts with clear objectives, time horizon, risk tolerance, and position sizing. Many investors use diversified allocation across core assets such as BTC/ETH, stablecoins for liquidity, and smaller satellite positions only when they understand the volatility. NexaVault keeps execution and portfolio records inside the signed-in account experience.',
    },
    {
        keywords: ['trade', 'trading', 'buy', 'sell', 'execute', 'execution'],
        text: 'Trading is different from long-term investing: define your entry, exit, invalidation level, and maximum loss before placing a buy or sell. On NexaVault, public users can study the market first, while authenticated users get the complete trade ticket, selected asset context, balances, order controls, and account records.',
    },
    {
    ...
    },
    {
        ...
        text: 'Wallet and funding actions should happen only inside a secure authenticated account. When you choose a wallet from the landing page, NexaVault routes you to sign in or create an account first so deposits, withdrawals, addresses, and records stay tied to your profile.',
    },
    {
...
const fallbackReplies = [
    'I can help with crypto investing, trading order types, asset selection, wallet funding, risk management, portfolio allocation, and how NexaVault routes account-only actions. Tell me the asset or trading concept you want to understand.',
    'For fintech-standard safety, NexaVault lets public users review markets first, then routes investing, selling, trading, and wallet actions through secure sign-in or account creation. Ask me about market, limit, stop, DCA, portfolio risk, or a specific asset.',
