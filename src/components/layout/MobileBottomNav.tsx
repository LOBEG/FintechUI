...
export function MobileBottomNav() {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 inset-x-0 z-30 border-t border-white/10 bg-ink-950/90 backdrop-blur-xl pb-[env(safe-area-inset-bottom)]">
            ...
            <li key={it.href}>
              <Link
                ...
                className={cn(
                  ...
                  active ? 'text-neon-green' : 'text-white/60 hover:text-white',
                )}
              >
