      ...
      <section className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-12 pb-6">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <h1 className="mt-4 text-3xl sm:text-4xl font-display">
            <span className="text-gradient-gold">NexaVault</span> Asset Management
          </h1>
          <p className="mt-2 text-white/65 max-w-3xl">
            NexaVault Asset Management combines live crypto market access, portfolio governance, custody coordination, and risk oversight for investors who need a transparent digital asset operating platform rather than a basic trading app.
          </p>
        </motion.div>
