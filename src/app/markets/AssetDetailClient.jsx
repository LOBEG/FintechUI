...
function aboutFor(sym) {
  return (
    ABOUT[sym] ||
    `${sym} is one of the assets supported on NexaVault spot. Live mid-market quotes are streamed from Binance and rounded to the asset's tick size on every fill.`
  );
}
