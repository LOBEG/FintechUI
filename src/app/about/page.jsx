...
export const metadata = {
    ...
    description: 'Learn about NexaVault - institutional-grade digital asset platform.',
};
      ...
      <main className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-display">
            About <span className="text-gradient-gold">NexaVault</span>
          </h1>
          <p className="mt-4 text-lg text-white/70">
            NexaVault is an institutional-grade cryptocurrency trading and digital asset management platform built around live market data, secure wallet operations, audited transaction records, and administrator-controlled investment servicing. We serve high-net-worth individuals, family offices, and corporate treasury teams that need transparent digital asset infrastructure.
          </p>
