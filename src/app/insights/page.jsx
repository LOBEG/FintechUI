...
const insights = [
    { tag: 'Macro', title: 'Rate cuts ahead: re-rating risk assets', author: 'NexaVault Research', time: '2h ago', desc: 'Dovish FOMC commentary suggests a constructive setup for BTC and tech-heavy crypto majors into Q4.', color: 'text-neon-green' },
    ...
    { tag: 'Equities', title: 'AI capex cycle vs. crypto correlation', author: 'NexaVault Research', time: '1d ago', desc: 'We dissect the rolling 30-day correlation between NDX and BTC, and what it implies for portfolio construction.', color: 'text-neon-orange' },
    { tag: 'DeFi', title: 'RWA tokenization: a $30T opportunity', author: 'NexaVault Research', time: '2d ago', desc: 'Tokenized treasuries, private credit, and real estate are catalyzing institutional flows into on-chain markets.', color: 'text-white' },
];
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-12 pb-6">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="mt-2 text-white/65 max-w-2xl">
            Daily macro briefings, on-chain analytics, and AI-curated market intelligence from the NexaVault research desk and Aurelia AI.
          </p>
        </motion.div>
      </section>
