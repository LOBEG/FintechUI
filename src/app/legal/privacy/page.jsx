...
export const metadata = {
    title: 'Privacy Policy - NexaVault',
    description: 'NexaVault Privacy Policy and data protection practices.',
};
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8 space-y-6 text-white/70">
            ...
            <section>
              ...
              <p className="mt-2">
                Under GDPR, you have the right to access, correct, delete, or port your data. You may object to processing or withdraw consent. Contact <a href="mailto:privacy@nexavault.com" className="text-neon-green hover:underline">privacy@nexavault.com</a> to exercise your rights.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                For privacy enquiries, contact our Data Protection Officer at <a href="mailto:privacy@nexavault.com" className="text-neon-green hover:underline">privacy@nexavault.com</a>.
              </p>
            </section>
          </div>
        </div>
